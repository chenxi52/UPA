...
for i, txt in enumerate(accuracy_visda):
    plt.annotate(f"{txt}", (Y[i], accuracy_visda[i] - 0.5), ha='center', color='black',fontsize=15)
for i, txt in enumerate(accuracy_office):
    plt.annotate(f"{txt}", (Y[i], accuracy_office[i] + 0.5), ha='center', color='black',fontsize=15)
...
for i, txt in enumerate(accuracy_visda_1):
    plt.annotate(f"{txt}", (tau[i], accuracy_visda_1[i] - 0.5), ha='center', color='black',fontsize=15)
for i, txt in enumerate(accuracy_office_1):
    plt.annotate(f"{txt}", (tau[i], accuracy_office_1[i] + 0.5), ha='center', color='black',fontsize=15)
...
for i, txt in enumerate(accuracy_visda_2):
    plt.annotate(f"{txt}", (k[i], accuracy_visda_2[i] - 0.5), ha='center', color='black',fontsize=15)
for i, txt in enumerate(accuracy_office_2):
    plt.annotate(f"{txt}", (k[i], accuracy_office_2[i] + 0.5), ha='center', color='black',fontsize=15)
