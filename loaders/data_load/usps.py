...
class USPS(data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, download=False, 
                 transform2=None, mem_label=None):
        """Init USPS dataset."""
        # init params
    ...
    def __getitem__(self, index):
        ...
        if self.transform2 is None:
            return img1, label.astype("int64"), index
        else:
            return img1, img2, label.astype("int64"), index
...
class USPS_idx(data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, download=False, transform2=None, mem_label=None):
        """Init USPS dataset."""
        # init params
        self.root = os.path.expanduser(root)
        self.filename = "usps_28x28.pkl"
